# -*- coding: utf-8 -*-
"""
Created on Wed Mar 19 08:20:18 2025
    ...
    def get_stock_metrics(self, symbol):
        try:
            ...
            metrics = {
                ...
                'EPS/Price (%)': round((info.get('trailingEps', 0) / info.get('currentPrice', 1)) * 100, 2),
                'Quick Ratio': round(info.get('quickRatio', 0), 2),
                'Free Cash Flow ($M)': round(info.get('freeCashflow', 0) / 1000000,2),
